<template>
  <div class="home" ref="home">
    <Canvas :id="id" :successAnim="successAnim" :displayContent="displayContent" :coordsContent="coordsContent" class="global-canvas" :nextProject="nextProject" />
    ...
    <div class="global-control-slide" :class="displayContent ? 'active' : ''">
      <div class="content-order" @mouseover="updateHover('enter')" @mouseleave="updateHover('leave')">
    ...
    <div class="bottom-left" @mouseover="updateHover('enter')" @mouseleave="updateHover('leave')" v-on:click="changeById(id+1 === 4 ? 0 : id+1)">
  ...
  export default {
    ...
    methods: {
      ...
      changeProject: function(_event) {
        ...
        if ((normalized.pixelY >= 30 && this.lockMouseWheel) || (_event.keyCode === 40 && normalized.pixelY === 0 && this.lockMouseWheel)) {
        ...
        } else if ((normalized.pixelY <= -30 && this.lockMouseWheel) || (_event.keyCode === 38 && normalized.pixelY === 0 && this.lockMouseWheel)) {
          if (this.id == 0) {
            this.id = 3
          } else {
            this.id--
...
.bg-round-yellow 
    ...
    z-index:1111
    background:#070808
    transition:1.2s .8s ease-in-out 
    display:flex
...
.confort-hover:hover .point .line 
  animation: showLine .5s ease-in-out forwards
